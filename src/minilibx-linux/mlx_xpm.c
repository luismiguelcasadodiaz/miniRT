...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/04 23:35:18 by luicasad          #+#    #+#             */
/*   Updated: 2024/09/05 00:51:45 by luicasad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	mlx_int_file_get_rid_comment(char *ptr, int size)
{
	...
	while (begin != -1)
	{
		end = mlx_int_str_str(ptr + begin + 2, "*/", size - begin - 2);
...
void	*mlx_xpm_file_to_image(t_xvar *xvar, char *file, int *wid, int *hei)
{
	int		fd;
	int		size;
	char	*ptr;
...
void	*mlx_xpm_to_image(t_xvar *xvar, char **xpm_data, int *wid, int *hei)
{
	t_img	*img;
